...
void status_message(string s)
{
	string temp = "";
	
	
	//output the message into text file
	ofstream fout("output_file.txt");
	fout << std::endl << s << std::endl << std::endl;
	fout.close();
	
	
	//read message from the text file and display it
	ifstream fin;
	fin.open("output_file.txt");
